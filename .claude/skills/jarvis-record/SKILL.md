...
落とし込むスキル。後段の [friday-deck](../friday-deck/) がこの記録を入力に、非エンジニア向けの
...
```bash
SKILL=/Users/satoshi-onga/Documents/onclimb-industries/.claude/skills/friday-record
TODAY=$(date +%F)
